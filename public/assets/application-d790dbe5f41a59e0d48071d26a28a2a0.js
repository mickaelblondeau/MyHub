...
(function() {
  $(function() {
    $(document).on("ajax:success", "#comment_block form[data-remote]", function(e, data, status, xhr) {
      return $('#comment_block').replaceWith(data);
    });
    $(document).on("ajax:success", "#like_block form[data-remote]", function(e, data, status, xhr) {
      return $('#like_block').replaceWith(data);
    });
    return $(document).on("ajax:success", "#vote_block form[data-remote]", function(e, data, status, xhr) {
