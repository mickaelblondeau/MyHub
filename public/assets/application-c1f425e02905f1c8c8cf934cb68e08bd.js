...
(function() {
  $(function() {
    $(document).on("ajax:success", "#like_block form[data-remote]", function(e, data, status, xhr) {
      return $('#like_block').replaceWith(data);
    });
    $(document).on("ajax:success", "#vote_block form[data-remote]", function(e, data, status, xhr) {
      return $('#vote_block').replaceWith(data);
    });
    $(document).on("ajax:success", "#new_comment[data-remote]", function(e, data, status, xhr) {
      $('#comment_block').prepend(data);
      return $('#comment_content').val('');
    });
    $(document).on("ajax:success", "#comment_block .delete_comment form[data-remote]", function(e, data, status, xhr) {
      return $('#comment-' + $(this).parent().attr('data-id')).remove();
    });
    return $(document).on("ajax:success", "#comment_block .comment_loader a[data-remote]", function(e, data, status, xhr) {
      $('#comment_block .comment_loader').remove();
      return $('#comment_block').append(data);
    });
  });
